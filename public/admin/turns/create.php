    ...
    <script>
        $(document).ready(function() {
            $("#formValidation").submit(function(e) {
                ...
                if (duration === "" || patient_id === "") {
                    alert('واردکردن مدت وبیمار الزامی است!');
                    e.preventDefault();
                }
            });
        });
...
<body>
    ...
    <div class="container">
        <form action="store.php?policlinic_id=<?= $_GET['policlinic_id'] ?>" method="POST" id="formValidation">
            <div class="row small">
                <div class="col-6">
                ...
                <div class="col-md-6 col-12">
                    ...
                    <input type="text" class="form-control flatpickr-datetime" name="time" placeholder="YYYY/MM/DD - HH:MM">
                </div>
                <div class="col-6">
                ...
                <div class="col-md-6 col-12 mb-4">
                    ...
                    <input type="text" class="form-control flatpickr-datetime" name="reservation_time" placeholder="YYYY/MM/DD - HH:MM">
                </div>
                <div class="col-6">
                    <label for="amount_visit">مبلغ ویزیت</label>
                    <input type="text" name="amount_visit" id="amount_visit" class="form-control" />
                </div>
            </div>
            <div class="row small">
                <div>

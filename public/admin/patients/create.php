    ...
    <script>
        $(document).ready(function() {
            $("#formValidation").submit(function(e) {
                ...
                if (username === "" || fullname === "" || mobile === "") {
                    alert('واردکردن کدملی،نام ونام خانوادگی ،شماره موبایل الزامی است!');
                    e.preventDefault();
                }
            });
        });
...
<body>
    <div class="container">
        <form action="store.php" method="POST" id="formValidation" enctype="multipart/form-data">
            <div class="row small">
                <div class="col-6 ">
